...
keyboard.keymap = [
    ...
    [
        ...
        KC.LCTL, KC.LALT, EscGUI , LowMins, KC.LCTL,  RaiEnt , Sands  , KC.GRV , KC.ENT , KC.RSFT
    ],
    # lower
    [
        ...
        KC.NO  , KC.NO  , KC.TRNS, KC.TRNS, KC.NO  ,  Adjust , KC.TRNS, KC.TRNS, KC.NO   , KC.NO
    ],
    # raise
    [
        ...
        KC.NO  , KC.NO  , KC.TRNS, Adjust , KC.NO  ,  KC.TRNS, KC.TRNS, KC.TRNS, KC.NO  , KC.NO
    ],
    # adjust
    [
        ...
        KC.NO  , KC.NO  , KC.TRNS, KC.TRNS, KC.NO  ,  KC.TRNS, KC.TRNS, KC.TRNS, KC.NO  , KC.NO
    ],
]
